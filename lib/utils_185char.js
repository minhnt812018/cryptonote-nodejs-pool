...
exports.validateMinerAddress = function(address) {
    ...
    else if (addressPrefix === integratedAddressBase58Prefix[0] || addressPrefix === integratedAddressBase58Prefix[1] || addressPrefix === integratedAddressBase58Prefix[2]) return true;
    return false;
}
